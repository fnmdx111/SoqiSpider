...
def initMysql(_logger, host="localhost",user='root',passwd='123456',db='companyinformation'):
...
def inserttoMysql(tuple,_logger=logger,tablename='companyinformation',):
...
if __name__=='__main__':
    ...
    initMysql(logging.getLogger(__name__))
    inserttoMysql(infor,logging.getLogger(__name__))
    finishInsertMysql()
